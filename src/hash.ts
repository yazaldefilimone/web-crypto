...
export async function createHash(input: string, algorithm: hashAlgoType = "SHA-256"): Promise<string> {
  ...
  const hashBuffer = await webCrypto.subtle.digest(algorithm, coded);
